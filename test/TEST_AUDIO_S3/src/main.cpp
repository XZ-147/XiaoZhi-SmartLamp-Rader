...
constexpr gpio_num_t AUDIO_I2S_GPIO_MCLK = GPIO_NUM_5;
constexpr gpio_num_t AUDIO_I2S_GPIO_BCLK = GPIO_NUM_15;
constexpr gpio_num_t AUDIO_I2S_GPIO_WS = GPIO_NUM_16;
constexpr gpio_num_t AUDIO_I2S_GPIO_DIN = GPIO_NUM_7;
constexpr gpio_num_t AUDIO_I2S_GPIO_DOUT = GPIO_NUM_6;

constexpr i2c_port_t AUDIO_CODEC_I2C_NUM = I2C_NUM_0;
constexpr gpio_num_t AUDIO_CODEC_I2C_SCL_PIN = GPIO_NUM_9;
constexpr gpio_num_t AUDIO_CODEC_I2C_SDA_PIN = GPIO_NUM_8;
...
constexpr bool ENABLE_LED_PWM = false;  // Disable LED PWM while testing mic.
...
constexpr uint8_t LED_STRIP_PIN = 38;
